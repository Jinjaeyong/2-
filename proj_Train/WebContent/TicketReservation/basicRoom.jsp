...
<div class="login">
	...
	<div id="login-form">
	<h2 class="login-header">일반실 예약페이지 예매정보확인</h2>
	
	<form class="login-container" action="basicRoomproc.do" method="post">
	 <table>
		<tr>
			<td>
			출발 :
			...
			<td>좌석 : 일반실${basicseat}</td>
		</tr>
			<td>가격 :
			<c:if test="${adult != 0 or child !=0 or old != 0 }">
				<c:if test="${gogo == '1' and finish == '2'}">${adult*5000+child*4000+old*4500}원
				</c:if>
				<c:if test="${gogo == '1' and finish == '3'}">${adult*9000+child*8000+old*8500}원
				</c:if>
				<c:if test="${gogo == '1' and finish == '4'}">${adult*19000+child*18000+old*18500}원
				</c:if>
				<c:if test="${gogo == '2' and finish == '1'}">${adult*5000+child*4000+old*4500}원
				</c:if>
				<c:if test="${gogo == '2' and finish == '3'}">${adult*4000+child*3000+old*3500}원
				</c:if>
				<c:if test="${gogo == '2' and finish == '4'}">${adult*17000+child*16000+old*16500}원
				</c:if>
				<c:if test="${gogo == '3' and finish == '1'}">${adult*9000+child*8000+old*8500}원
				</c:if>
				<c:if test="${gogo == '3' and finish == '2'}">${adult*4000+child*3000+old*3500}원
				</c:if>
				<c:if test="${gogo == '3' and finish == '4'}">${adult*15000+child*14000+old*14500}원
				</c:if>
				<c:if test="${gogo == '4' and finish == '1'}">${adult*19000+child*18000+old*18500}원
				</c:if>
				<c:if test="${gogo == '4' and finish == '2'}">${adult*17000+child*16000+old*16500}원
				</c:if>
				<c:if test="${gogo == '4' and finish == '3'}">${adult*15000+child*14000+old*14500}원
				</c:if>
			</c:if>	
