...
<body>
	...
	<div id="login-form">
	<h2 class="login-header">티켓 메뉴</h2>
	<form class="login-container" action="reservationMenu.do">
		<p><input color="color1" type="submit" value="승차권 예약 페이지"/></p>
	</form>
	
	<form class="login-container"  action="viewTicket.do">
		<p><input color="color3" type="submit" value="예약 승차권 확인"/></p>
	</form>
	<form class="login-container"  action="../member/myMenu.do">
