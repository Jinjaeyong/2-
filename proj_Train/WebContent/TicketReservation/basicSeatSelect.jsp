...
<div class="login">
	...
	<div id="login-form">
	<h2 class="login-header">일반실 자리선택</h2>
	<form class="login-container" action="basicSeatSelectProc.do" method="post">
		<table>
			<tr>
				<%-- <%for(int i =0 ;i<40; i+=4) {%> --%>
				<c:forEach var="i" begin="0" end="39" step="4">
				<td>
				<input type="checkbox" name="basicseat" value="${i+1}">
					<c:choose>
					<c:when test="${basicseat == i+1 }">
			...
			<tr>
				...
				<td>
				<input type="checkbox" name="basicseat" value="${j+1}">
					<c:choose>
					<c:when test="${basicseat == j+1 }">
			...
			<tr>
				...
				<td>
				<input type="checkbox" name="basicseat" value="${x+1}">
					<c:choose>
					<c:when test="${basicseat == x+1 }">
			...
			<tr>
				...
				<td>
				<input type="checkbox" name="basicseat" value="${y+1}">
					<c:choose>
					<c:when test="${basicseat == y+1 }">
