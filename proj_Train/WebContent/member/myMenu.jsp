...
<body>	
	...
	<div id="login-form">
	<h2 class="login-header">My Menu  ~~ ${mid} 님 환영합니다.</h2>
	<form class="login-container" action="memberMenu.do">
		<p><input color="color1" type="submit" value="수정"/></p>
	</form>
	
	<form class="login-container"  action="../TicketReservation/ticketMenu.do">
		<p><input color="color3" type="submit" value="티켓 메뉴 페이지"/></p>
	</form>
	
	<form class="login-container"  action="../TrainMain.jsp">
		<p><input color="color4" type="submit" value="메인으로가기"/></p>
	</form>
	</div>
	</div>
</body>
